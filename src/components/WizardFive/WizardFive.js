    ...
    render(){
        ...
        return(
            <div className="parent-div">
                    ...
                    <div className="row">
                        <Link to="/wSix"><button value="Yes" onClick={(e) => updateRealEstateAgent(e.target.value)}>Yes</button></Link>
                        <Link to="/wSix"><button value="No" onClick={(e) => updateRealEstateAgent(e.target.value)}>No </button></Link>
                    </div>
                </div>
            </div>
        )
