        ...
        return(
            <div className="parent-div">
                <div className="vert-align">            
                    ...
                    <div className="row">
                        <Link to="/wFive"><button value="Yes" onClick={(e) => updateFound(e.target.value)}>Yes</button></Link>
                        <Link to="/wFive"><button value="No" onClick={(e) => updateFound(e.target.value)}>No </button></Link>  
                    </div>         
                </div>
            </div>
        )
